...
public class TestData
{
    ...
    public String
            ...
            userBirthYear = String.format("%s",faker.number().numberBetween(1900,2200)),
            subject = faker.options().option("Accounting", "Art", "Physics", "Chemistry", "Economics", "English", "Biology"),
